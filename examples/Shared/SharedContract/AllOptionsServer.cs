...
namespace SharedContract
{
    ...
    {
        public static IAsyncEnumerable<T> AsAsyncEnumerable<T>(this IAsyncStreamReader<T> reader, ServerCallContext context)
            => AsAsyncEnumerableImpl(reader, context.CancellationToken);

        private static async IAsyncEnumerable<T> AsAsyncEnumerableImpl<T>(IAsyncStreamReader<T> reader, [EnumeratorCancellation] CancellationToken cancellationToken)
        {
            using (reader)
            {
    ...
    class AllOptionsServer : IAllOptions
    {
        ...
        private static readonly DuplexStreamingServerMethod<AllOptionsServer, HelloRequest, HelloReply> Shared_Duplex_Context
            = (service, request, response, context) => ((IAllOptions)service).Shared_Duplex_Context(request.AsAsyncEnumerable(context), new CallContext(context)).WriteTo(response, context);
        IAsyncEnumerable<HelloReply> IAllOptions.Shared_Duplex_Context(IAsyncEnumerable<HelloRequest> request, CallContext context)
        ...
        private static readonly DuplexStreamingServerMethod<AllOptionsServer, HelloRequest, HelloReply> Shared_Duplex_NoContext
            = (service, request, response, context) => ((IAllOptions)service).Shared_Duplex_NoContext(request.AsAsyncEnumerable(context)).WriteTo(response, context);
        IAsyncEnumerable<HelloReply> IAllOptions.Shared_Duplex_NoContext(IAsyncEnumerable<HelloRequest> request)
            => throw new NotImplementedException();
        ...
        IAsyncEnumerable<HelloReply> IAllOptions.Shared_ServerStreaming_Context(HelloRequest request, CallContext context)
            => throw new NotImplementedException();
        ...
        IAsyncEnumerable<HelloReply> IAllOptions.Shared_ServerStreaming_NoContext(HelloRequest request)
            => throw new NotImplementedException();
        ...
        private static readonly ClientStreamingServerMethod<AllOptionsServer, HelloRequest, HelloReply> Shared_TaskClientStreaming_Context
            = (service, request, context) => ((IAllOptions)service).Shared_TaskClientStreaming_Context(request.AsAsyncEnumerable(context), new CallContext(context));
        Task<HelloReply> IAllOptions.Shared_TaskClientStreaming_Context(IAsyncEnumerable<HelloRequest> request, CallContext context)
            => throw new NotImplementedException();
        ...
        private static readonly ClientStreamingServerMethod<AllOptionsServer, HelloRequest, HelloReply> Shared_TaskClientStreaming_NoContext
            = (service, request, context) => ((IAllOptions)service).Shared_TaskClientStreaming_NoContext(request.AsAsyncEnumerable(context));
        Task<HelloReply> IAllOptions.Shared_TaskClientStreaming_NoContext(IAsyncEnumerable<HelloRequest> request)
            => throw new NotImplementedException();

        // **** STOPPED HERE

        Task<HelloReply> IAllOptions.Shared_TaskUnary_Context(HelloRequest request, CallContext context)
            => throw new NotImplementedException();

        Task<HelloReply> IAllOptions.Shared_TaskUnary_NoContext(HelloRequest request)
            => throw new NotImplementedException();

        ValueTask<HelloReply> IAllOptions.Shared_ValueTaskClientStreaming_Context(IAsyncEnumerable<HelloRequest> request, CallContext context)
            => throw new NotImplementedException();

        ValueTask<HelloReply> IAllOptions.Shared_ValueTaskClientStreaming_NoContext(IAsyncEnumerable<HelloRequest> request)
            => throw new NotImplementedException();

        ValueTask<HelloReply> IAllOptions.Shared_ValueTaskUnary_Context(HelloRequest request, CallContext context)
            => throw new NotImplementedException();

        ValueTask<HelloReply> IAllOptions.Shared_ValueTaskUnary_NoContext(HelloRequest request)
            => throw new NotImplementedException();



        AsyncUnaryCall<HelloReply> IAllOptions.Client_AsyncUnary(HelloRequest request, CallOptions options)
    => throw new NotSupportedException();

        HelloReply IAllOptions.Client_BlockingUnary(HelloRequest request, CallOptions options)
            => throw new NotSupportedException();

        AsyncClientStreamingCall<HelloRequest, HelloReply> IAllOptions.Client_ClientStreaming(CallOptions options)
            => throw new NotSupportedException();

        AsyncDuplexStreamingCall<HelloRequest, HelloReply> IAllOptions.Client_Duplex(CallOptions options)
            => throw new NotSupportedException();

        AsyncServerStreamingCall<HelloReply> IAllOptions.Client_ServerStreaming(HelloRequest request, CallOptions options)
            => throw new NotSupportedException();
    }
}
